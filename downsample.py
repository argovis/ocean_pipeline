...
parser.add_argument("--simple_choice", type=str, help="if 'True', just choose the first profile in each bin, instead of using the more complex helper function to choose a winner")
